...
namespace Project01_Introduction
{
    ...
    class L1_Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Area = SquareRoot(s * (s-a) * (s-b) * (s-c)) where s=(a+b+c)/2 and a,b,c
...
if (income < 400000)
            ...
            while (stopProgram == false)
            {
              ...
              // Exercise 4
              // Input a value (n) from the user and calculate the sum of first n natural
           // numbers.
            ...
            Debug.WriteLine("Tax liability is " + taxLiability);
            // Exercise 7
            // Write a method that accepts a parameter (n) and returns the sum of first n
            //natural numbers.
// Write your code here
// example 7 - arrays
